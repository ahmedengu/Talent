...
import tmpModelPack.tables.records.DatabasechangeloglockRecord;
...
import tmpModelPack.tables.records.PostTagRecord;
...
public class Keys {
    ...
    private static class ForeignKeys0 extends AbstractKeys {
        public static final ForeignKey<CommentRecord, NotificationRecord> FKCOMMENT389790 = createForeignKey(tmpModelPack.Keys.KEY_NOTIFICATION_PRIMARY, Comment.COMMENT, "FKComment389790", Comment.COMMENT.NOTIFICATION_ID);
        public static final ForeignKey<CommentRecord, PostRecord> FKCOMMENT460056 = createForeignKey(tmpModelPack.Keys.KEY_POST_PRIMARY, Comment.COMMENT, "FKComment460056", Comment.COMMENT.POST_ID);
        public static final ForeignKey<FollowerRecord, NotificationRecord> FKFOLLOWER973342 = createForeignKey(tmpModelPack.Keys.KEY_NOTIFICATION_PRIMARY, Follower.FOLLOWER, "FKFollower973342", Follower.FOLLOWER.NOTIFICATION_ID);
        public static final ForeignKey<FollowerRecord, UserRecord> FKFOLLOWER837875 = createForeignKey(tmpModelPack.Keys.KEY_USER_PRIMARY, Follower.FOLLOWER, "FKFollower837875", Follower.FOLLOWER.USER_ID);
        public static final ForeignKey<LikeRecord, NotificationRecord> FKLIKE895787 = createForeignKey(tmpModelPack.Keys.KEY_NOTIFICATION_PRIMARY, Like.LIKE, "FKLike895787", Like.LIKE.NOTIFICATION_ID);
        public static final ForeignKey<LikeRecord, PostRecord> FKLIKE225956 = createForeignKey(tmpModelPack.Keys.KEY_POST_PRIMARY, Like.LIKE, "FKLike225956", Like.LIKE.POST_ID);
        public static final ForeignKey<NotificationRecord, UserRecord> FKNOTIFICATI729821 = createForeignKey(tmpModelPack.Keys.KEY_USER_PRIMARY, Notification.NOTIFICATION, "FKNotificati729821", Notification.NOTIFICATION.USER_ID);
        public static final ForeignKey<PostRecord, UserRecord> FKPOST790237 = createForeignKey(tmpModelPack.Keys.KEY_USER_PRIMARY, Post.POST, "FKPost790237", Post.POST.USER_ID);
        public static final ForeignKey<PostRecord, CategoryRecord> FKPOST991094 = createForeignKey(tmpModelPack.Keys.KEY_CATEGORY_PRIMARY, Post.POST, "FKPost991094", Post.POST.CATEGORY_ID);
        public static final ForeignKey<PostTagRecord, TagRecord> FKPOST_TAG387460 = createForeignKey(tmpModelPack.Keys.KEY_TAG_PRIMARY, PostTag.POST_TAG, "FKPost Tag387460", PostTag.POST_TAG.TAG_ID);
        public static final ForeignKey<PostTagRecord, PostRecord> FKPOST_TAG508815 = createForeignKey(tmpModelPack.Keys.KEY_POST_PRIMARY, PostTag.POST_TAG, "FKPost Tag508815", PostTag.POST_TAG.POST_ID);
        public static final ForeignKey<RateRecord, NotificationRecord> FKRATE67125 = createForeignKey(tmpModelPack.Keys.KEY_NOTIFICATION_PRIMARY, Rate.RATE, "FKRate67125", Rate.RATE.NOTIFICATION_ID);
        public static final ForeignKey<RateRecord, PostRecord> FKRATE54619 = createForeignKey(tmpModelPack.Keys.KEY_POST_PRIMARY, Rate.RATE, "FKRate54619", Rate.RATE.POST_ID);
        public static final ForeignKey<TopRatedRecord, UserRecord> FKTOP_RATED153800 = createForeignKey(tmpModelPack.Keys.KEY_USER_PRIMARY, TopRated.TOP_RATED, "FKTop Rated153800", TopRated.TOP_RATED.USER_ID);
        public static final ForeignKey<TopRatedRecord, CategoryRecord> FKTOP_RATED354657 = createForeignKey(tmpModelPack.Keys.KEY_CATEGORY_PRIMARY, TopRated.TOP_RATED, "FKTop Rated354657", TopRated.TOP_RATED.CATEGORY_ID);
    }
}
